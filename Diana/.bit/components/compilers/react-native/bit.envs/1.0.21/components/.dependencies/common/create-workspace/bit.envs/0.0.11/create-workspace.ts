...
export async function createWorkspace(content: WorkspaceContent,
	options: WorkspaceOptions): Promise<string> {
...
function enrichContentWithDefaults(content: WorkspaceContent,
						...
						meta2: {
							options: {
								file: options.envTester ?
									path.resolve(options.envTester) :
									''
							}
						}
					}
