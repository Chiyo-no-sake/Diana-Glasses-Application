...
function buildComponentInWorkspace(helper, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!opts || opts.disableBuildStep !== true) {
            ...
            results.files = yield fs_extra_1.default.readdir(path_1.default.join(results.directory, '/dist'));
        }
...
function removeWorkspace(directory) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => rimraf_1.default(directory, {}, error => (error ? reject() : resolve())));
    });
}
