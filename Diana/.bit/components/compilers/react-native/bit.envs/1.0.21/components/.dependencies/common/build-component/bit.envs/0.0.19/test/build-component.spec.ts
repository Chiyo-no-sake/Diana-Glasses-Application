...
describe('build component functions', function () {
	it('getFileName - should return the correct file name', function () {
		...
		expect(getFileName('src/components/button.spec.ts')).to.equal(
			'button.spec.ts');
		expect(getFileName('src/components/assets/data.json')).to.equal(
			'data.json');
	});
	it('getBitAddCommand - should work with default component object',
		function () {
	...
	it('getBitAddCommand - should work with custom component object',
		function () {
	...
	it('getBitAddCommand - should work with custom component object and test files',
		function () {
			const component: GenericObject = {
				'src/button.tsx': '',
				'src/style.css': '',
